    ...
    <main className="overflow-x-clip pb-16">
      <section className="page-bleed border-b border-cyan-200/70 bg-[linear-gradient(135deg,#f9fdff_0%,#e6f6ff_52%,#fff6d4_100%)] text-slate-900">
        ...
        >
          ...
          >
            <Badge className="w-fit border border-cyan-200/80 bg-white/80 text-slate-800">Author studio</Badge>
            <div className="space-y-4">
              <h1 className="max-w-2xl text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
                Create a post inside the same full-bleed workspace used across the dashboard
              </h1>
              <p className="max-w-2xl text-sm leading-7 text-slate-700 md:text-base">
                Compose content with the block editor, upload an optional cover image, and submit for
                moderation without leaving a constrained, readable form area.
              </p>
            </div>
          ...
          >
            <div className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                ...
                <p className="mt-1 text-lg font-semibold text-slate-900">{profile?.subscription.planName ?? "Free"}</p>
              </div>
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-700">Allowed</p>
                <p className="mt-1 text-lg font-semibold text-slate-900">{postQuota?.allowedPosts ?? 0}</p>
              </div>
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-700">Remaining</p>
                <p className="mt-1 text-lg font-semibold text-slate-900">{postQuota?.remainingPosts ?? 0}</p>
              </div>
            </div>
          </MotionDiv>
        </MotionSection>
