          ...
          >
            ...
            <div className="space-y-4">
              <h1 className="max-w-2xl text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
                Edit your post with the same constrained workspace and full-width canvas
              </h1>
              <p className="max-w-2xl text-sm leading-7 text-slate-700 md:text-base">
                The editing experience keeps the form readable, preserves the block editor, and uses the hero
                area for status and navigation context.
              </p>
            </div>
          ...
          >
            <div className="grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                ...
                <p className="mt-1 text-lg font-semibold text-slate-900">{currentStatus || "-"}</p>
              </div>
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-700">Tags</p>
                <p className="mt-1 text-lg font-semibold text-slate-900">{tagIds.length}</p>
              </div>
              <div className="rounded-2xl border border-cyan-200/80 bg-white/80 px-4 py-4 shadow-[0_16px_40px_rgba(2,6,23,0.12)] backdrop-blur">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-700">Blocks</p>
                <p className="mt-1 text-lg font-semibold text-slate-900">{previewBlocks.length}</p>
              </div>
            </div>
          </MotionDiv>
        </MotionSection>
