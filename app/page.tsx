...
export default function Home() {
  return (
    <main className="pb-14 pt-10">
            ...
            <div className="grid gap-8 bg-gradient-to-br from-cyan-600 via-sky-500 to-amber-300 p-8 text-white md:grid-cols-[1.35fr_1fr] md:p-10">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Link
                    href="/dashboard"
                    className="rounded-xl border border-white/70 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/15"
                  >
                    Open dashboard
                  </Link>
                </div>
      ...
      <section className="section-shell mt-8 grid gap-4 md:grid-cols-3">
        {highlights.map((item) => (
          <Card key={item}>
            <CardHeader>
